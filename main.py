...
class AutomatizadorApp:
    ...
    def contar_imagenes_adjuntas(self) -> int:
        ...
        boton_ver = self._buscar_boton(self.ventana_principal, NOMBRE_BOTON_VER_IMAGENES)
        boton_ver.click()
        time.sleep(PAUSA_CORTA * 2)
    ...
    def adjuntar_archivo(self, ruta_archivo: str):
        ...
        boton_adjuntar = self._buscar_boton(self.ventana_principal, NOMBRE_BOTON_ADJUNTAR)
